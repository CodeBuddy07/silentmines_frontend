                ...
                {category.subCategories.map((subCategory: SubCategory) => {
                  ...
                  return (
                    <Button
                      ...
                      className={`px-6 py-2 rounded-full transition-all duration-300 ${activeSubCategory === subCategory.slug
                        ? "bg-green-600 text-white border-green-600 shadow-lg shadow-green-600/20"
                        : "bg-transparent text-gray-300 border-gray-600 hover:border-green-500 hover:text-green-400"
                        }`}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <span className="text-green-400 font-medium">
                    Filtered by: {category.subCategories?.find((sub: SubCategory) => sub.slug === activeSubCategory)?.name}
                  </span>
              ...
              <p className="text-sm text-gray-300">
                ...
                {activeSubCategory && activeSubCategory !== 'all' && (
                  <span className="ml-2 text-green-400">
                    in {category.subCategories?.find((sub: SubCategory) => sub.slug === activeSubCategory)?.name}
                  </span>
                )}
              </p>
            </div>
