...
const Page = () => {
  ...
  const handleSaveTime = (day: string, time: string) => {
    console.log("Saved Time:", { day, time });
    // Perform the save operation here, such as sending the data to an API
  };
  ...
  return (
    <div className='space-y-6'>
      ...
      <div>
        {/* add time for today and tomorrow */}
        <div className='flex items-center gap-2'>
          ...
          <Button
            className='bg-[#00A63E] cursor-pointer'
          // onClick={() => setIsManageTimeOpen(true)}
          >Manage Tomorrow Times</Button>
